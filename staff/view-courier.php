                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Shipment View</h4>
 <?php if($msg){?>                                   
...
?>
  ...
  <p><strong>Shipment Date :</strong> <?php  echo $row['CourierDate'];?></p>
    <div class="row">                                    
<div class="col-6">
...
<div class="col-6">
  <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  <tr>
    <th style="text-align: center" colspan="2"> Misc Information</th>
  </tr>
  <tr>
    <th>Manifest Number</th>
    <td><?php echo $row['ManifestNumber'] ?></td>
  </tr>
  <tr>
    <th>Vessel Name</th>
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  <tr align="center">
   <th colspan="4" >Shipment History</th> 
  </tr>
  <tr>
    <th>#</th>
<th>Remark</th>
