                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">BDZ Sales Report</h4>
...
<form name="bwdatesreport"  action="sales-report-details.php" method="post"> 
                ...
                <input type="radio" name="requesttype" value="dtwise" checked="true">Date wise
