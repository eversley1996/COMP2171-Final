                        ...
                        <div class="row">
							<div class="col-xl-12">
								<div class="page-title-box">
                                    <h4 class="page-title float-left">BDZ Dashboard</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="total-courier.php">Total Shipment</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="courierpickup.php">Total Shipment Pickup</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="intransit.php">Instransit Shipment</a>
...
?>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="icon-layers float-right text-muted"></i>
                                    <a class="text-muted text-uppercase m-b-20" href="arriveddes.php">Total Shipment Arrived at destination</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="icon-paypal float-right text-muted"></i>
                                    <a class="text-muted text-uppercase m-b-20" href="outfordelivery.php">Total Shipment Out for Delivery</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="icon-chart float-right text-muted"></i>
                                    <a class="text-muted text-uppercase m-b-20" href="delivered.php">Total Delivered Shipment</a>
