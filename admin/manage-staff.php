...
<?php if($row['status']=="1"){?>
<a href="manage-staff.php?inactiveid=<?php echo $row['ID'];?>" title="Inactive this account" onclick="return confirm('Do you really want to deactivate this account?');">Inactive</a>
<?php } else {?>
<a href="manage-staff.php?activeid=<?php echo $row['ID'];?>" title="Active this account" onclick="return confirm('Do you really want to activate this account?');">Active</a>
    <?php } ?>
                  </td>
                </tr>
                <?php 
