...
<html lang="en">
    ...
    <head>
        <title>BDZ Reports Counts</title>
...
$tdate=$_POST['todate'];
?>
<h5 align="center" style="color:blue">Shipment Request Count Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
<tr>
<th>S.NO</th>
<th>Total Shipment Listed</th>
<th>Not Picked up yet</th>
<th>Total Shipment Pickup</th>
<th>Total Shipped</th>
